<?php
/**
 * Wildenstein Theme Customizer support
 *
 * @package WordPress
...
function twentyfourteen_contextual_help() {
	...
	get_current_screen()->add_help_tab( array(
		'id'      => 'twentyfourteen',
		'title'   => __( 'Wildenstein', 'twentyfourteen' ),
		'content' =>
			'<ul>' .
				...
				'<li>' . sprintf( __( 'Enhance your site design by using <a href="%s">Featured Images</a> for posts you&rsquo;d like to stand out (also known as post thumbnails). This allows you to associate an image with your post without inserting it. Wildenstein uses featured images for posts and pages&mdash;above the title&mdash;and in the Featured Content area on the home page.', 'twentyfourteen' ), 'http://codex.wordpress.org/Post_Thumbnails#Setting_a_Post_Thumbnail' ) . '</li>' .
				'<li>' . sprintf( __( 'For an in-depth tutorial, and more tips and tricks, visit the <a href="%s">Wildenstein documentation</a>.', 'twentyfourteen' ), 'http://codex.wordpress.org/wildenstein' ) . '</li>' .
			'</ul>',
	) );
}
